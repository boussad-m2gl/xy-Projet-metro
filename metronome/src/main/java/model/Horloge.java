...
public class Horloge implements IHorloge, Observer {
	...
	private GestionnaireEvtMM controleur; // l'horloge connait son controlleur
											// tous comme le moteur
	...
	public void desactiver(Command cmd) {
		stopChrono(); // TODO how to stop a given task within the timer ! ,we
						// have n't dealt with it cause it is not useful in our
						// case
	}
